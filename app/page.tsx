...
import PluggyLogo from '@/components/PluggyLogo'
...
const resources = [
  ...
  {
    title: 'Pluggy Supabase Next.js example app for investments',
    subtitle:
      'Check out this repo to understand a full example of how to use Pluggy, Supabase and Next.js to build a fintech app.',
    url: '/templates/investments-manager',
      ...
      <div className="animate-in flex flex-col gap-14 max-w-4xl px-3 py-16 lg:py-24 text-foreground">
        <div className="flex flex-col items-center mb-4 lg:mb-12">
          <div className="flex gap-8 justify-center items-center">
            <Link href="https://pluggy.ai/" target="_blank">
              <PluggyLogo />
            </Link>
          ...
          <p className="text-3xl lg:text-4xl !leading-tight mx-auto max-w-xl text-center my-12">
            Build fintech apps with <strong>Pluggy</strong>, <strong>Supabase</strong> and{' '}
        ...
        <div className="flex justify-center text-center text-xs">
          <p>
            Powered by{' '}
            <Link href="https://pluggy.ai/" target="_blank" className="font-bold">
              Pluggy
            </Link>
          </p>
        </div>
